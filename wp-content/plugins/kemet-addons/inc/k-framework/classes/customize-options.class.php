  ...
  class KFW_Customize_Options extends KFW_Abstract {
      ...
      if( ! empty( $this->sections ) ) {
        ...
        foreach( $sections as $section ) {
          ...
          if( ! empty( $section['subs'] ) ) {
            ...
            $wp_customize->add_panel( new WP_Customize_Panel_KFW( $wp_customize, $panel_id, array(
    ...
    public function add_section( $wp_customize, $section_id, $section_args, $panel_id ) {
      ...
      if( ! empty( $section_args['assign'] ) ) {
        ...
        $wp_customize->add_section( new WP_Customize_Section_KFW( $wp_customize, $section_id, array(
      ...
      if( ! empty( $section_args['fields'] ) ) {
        ...
        foreach( $section_args['fields'] as $field ) {
          ...
          $wp_customize->add_control( new WP_Customize_Control_KFW( $wp_customize, $setting_id,
