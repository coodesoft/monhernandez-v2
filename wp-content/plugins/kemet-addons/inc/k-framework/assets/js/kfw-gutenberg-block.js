...
( function( blocks, editor, element, components ) {
  ...
  if( !window.kfw_gutenberg_blocks ) { return; }

  window.kfw_gutenberg_blocks.forEach( function( block ) {
    ...
    registerBlockType('kfw-gutenberg-block/block-'+block.hash, {
        ...
        edit: function (props) {
          return (
            createElement('div', {className: 'kfw-shortcode-block'},

              createElement(Button, {
                'data-modal-id': block.modal_id,
                'data-gutenberg-id': block.hash,
                className: 'button is-button is-default is-large kfw-shortcode-button',
                onClick: function () {
                  window.kfw_gutenberg_props = props;
                },
              }, block.button_title ),
